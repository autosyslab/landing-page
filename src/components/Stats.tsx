    ...
    <section className="bg-gradient-to-b from-white via-slate-50 via-slate-200 via-slate-400 via-slate-600 via-slate-700 via-slate-800 to-[#0b1320] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-24">
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {S.items.map(item => (
            <div key={item.pct} className="rounded-2xl bg-white/5 border border-white/10 p-6 text-center backdrop-blur-sm hover:bg-white/10 transition-all duration-300">
